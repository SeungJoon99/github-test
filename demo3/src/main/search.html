	...
	<body>
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li class="active" aria-current="page">
							<a class="nav-link" href="main.html">상품 보기</a>
						</li>
		...
		<div class="hero" style="padding-bottom: 0px;">
			...
			<div class="row bg-dark" style="border: none;">
				...
				<li class="nav-item">
					<a class="nav-link" href="bed.html">침대</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="sofa.html">소파</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="closet.html">옷장</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="mattress.html">매트리스</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="table.html">테이블</a>
				</li>
					<div class="col-2"></div>
			</div>
			<!-- End navtap Section -->
		...
		<div class="untree_co-section product-section before-footer-section">
		    <div class="container">
				...
				<!-- <div class="form-group">
					<label for="sort" class="text-black">정렬</label>
				...
				<form>
                    <div class="d-flex">
                        ...
                        <label class="form-check-label" for="searchkind5">다이닝</label>
                    </div>
                </form>
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5">
                    <a class="product-item" href="chair_green.html">
                ...
                <!-- Start Column 2 -->
                <div class="col-12 col-md-4 col-lg-3 mb-5">
                    <a class="product-item" href="chair_baige.html">
                ...
                <!-- Start Column 3 -->
                <div class="col-12 col-md-4 col-lg-3 mb-5">
                    <a class="product-item" href="chair_kruzo.html">
